...
return [
    ...
    'email'                => '.عنوان بريد إلكتروني صحيح البُنية :attribute يجب أن يكون حقل',
    ...
    // converted validations
    'name' => [
        'required' => '.حقل الاسم مطلوب',
        'string' => '.يحب ان يكون حقل الاسم نصًا',
        'max' => '.يجب أن لا يتجاوز طول نّص حقل الاسم عن :max حرف',
    ],
    'email' => [
        'required' => '.حقل البريد الالكتروني مطلوب',
        'string' => '.يحب ان يكون حقل البريد الالكتروني نصًا',
        'email' => '.يجب أن يكون حقل البريد الالكتروني عنوان بريد إلكتروني صحيح البُنية',
        'max' => '.يجب أن لا يتجاوز طول نّص حقل البريد الالكتروني عن :max حرف',
        'unique' => '.قيمة حقل البريد الالكتروني مستخدمة من قبل',
    ],
    'password' => [
        'required' => '.حقل كلمة المرور مطلوب',
        'string' => '.يحب ان يكون حقل كلمة المرور نصًا',
        'min' => '.يجب أن لا يقل طول نّص حقل كلمة المرور عن :min حرف',
        'confirmed' => '.فضلا ادخل كلمة المرور مرة اخري بشكل متطابق',
    ],
    'old_password' => [
        'required' => '.حقل كلمة المرور القديمة مطلوب',
        'string' => '.يحب ان يكون حقل كلمة المرور القديمة نصًا',
    ],
    'roles' => [
        'required' => '.حقل الصلاحية مطلوب',
        'exists' => '.الحقل المحدد للصلاحية غير موجود',
    ],
    'phone' => [
        'required' => '.حقل رقم الهاتف مطلوب',
        'string' => '.يحب ان يكون حقل رقم الهاتف نصًا',
        'unique' => '.قيمة حقل رقم الهاتف مستخدمة من قبل',
    ]
];
