...
class RoleController extends Controller
{
    ...
    {
        $roles = Role::with('permissions')->where('guard_name','admin')->orderBy('id', 'desc')->get();
    ...
    public function store(Request $request)
    {
        $data = $this->validate($request, [
            ...
            'permission.*' => 'required|string|exists:permissions,name,guard_name,admin',
        ], [
    ...
    /**
     * Get all admins has specific role by roleName.
     *
    ...
    {
        $admins= Admin::role($roleName)->orderBy('id', 'desc')->get();
